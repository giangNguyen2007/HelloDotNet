...
builder.Services.AddDbContext<GameDBContext>(option =>
{
    ...
    //option.UseNpgsql("Host=localhost;Database=db;Username=user;Password=gng");
    option.UseMySQL("Server=localhost;Database=mydatabase;User=myuser;Password=mypassword;");
